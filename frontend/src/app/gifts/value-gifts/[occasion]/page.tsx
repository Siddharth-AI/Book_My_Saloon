...
export default function GiftCustomizationPage() {
  ...
  const occasionSlug = params.occasion as string; // 4. Access the 'occasion' parameter

  const [mainImage, setMainImage] = useState("/images/christmas-card.png");
  ...
  const thumbnails = [
    "/images/christmas-card-thumb1.png",
    "/images/christmas-card-thumb2.png",
    "/images/christmas-card-thumb3.png",
    "/images/flower-thumb.png",
  ];
