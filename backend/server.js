...
// const processImage = require("express-processimage");  // Temporarily disabled
const fs = require("fs");
...
// app.use(processImage());  // Temporarily disabled
...
// Start server
const port = process.env.NODE_ENV === "production" ? process.env.PORT || 8080 : 3005;
...
server.listen(port, () => {
    console.log(
        "%s server is running at https://%s:%s",
